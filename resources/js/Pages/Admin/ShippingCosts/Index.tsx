    ...
    return (
        <AdminLayout title="Ongkos Kirim" breadcrumbs={configurationSectionBreadcrumbs('Ongkir')}>
            ...
            <Card><CardContent className="p-0">
                <AdminTableScroll>
                        <Table><TableHeader><TableRow><TableHead>Kota</TableHead><TableHead>Ongkir</TableHead><TableHead>Per Kg</TableHead><TableHead>Status</TableHead><TableHead className="w-[1%] whitespace-nowrap text-right">Aksi</TableHead></TableRow></TableHeader>

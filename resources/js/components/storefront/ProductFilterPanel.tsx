...
export function buildFilterUrl(filters: ProductFilters, overrides: Partial<ProductFilters> = {}) {
...
export function ProductFilterPanel({
    ...
    return (
        <>
            {showHeader && (
                <div className="border-b bg-muted/60 px-4 py-3 lg:hidden">
            ...
            <div className="border-t px-4 py-3 pb-6">

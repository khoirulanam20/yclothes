                    ...
                    <form action="/products" method="get" className="flex flex-1 min-w-0">
                        <div className="relative w-full">
                            ...
                            <Input
                                ...
                                className="h-10 border-0 bg-transparent shadow-none rounded-none rounded-r-full pl-9 focus-visible:ring-0 focus-visible:ring-offset-0"
                            />
                        </div>
                    </form>
                </div>
                ...
                <div className="flex items-center gap-1 shrink-0">
                    {auth.customer ? (
                        <Link
                            ...
                            className="hidden sm:flex items-center gap-1.5 text-sm px-2 py-1.5 hover:text-primary"
                        >
